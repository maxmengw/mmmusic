...
export async function validateChineseAddToExample(
	req: Request,
	res: Response,
	next: NextFunction
): Promise<void> {
	...
	req.body = value;
	const { name, example } = req.body as AddChineseToExampleDto;
...
export async function validateChineseDeleteFromExample(
	req: Request,
	res: Response,
	next: NextFunction
): Promise<void> {
	...
	req.body = value;
	const { name, example } = req.body as DeleteChineseFromExampleDto;
